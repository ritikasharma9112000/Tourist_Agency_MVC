...
namespace Tourist_Agency_MVC.Controllers
{
    public class AgenciesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Agency_Name,Agency_Phone,Agency_Address,Agency_Email,Agency_Website")] Agency agency)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Agency_Name,Agency_Phone,Agency_Address,Agency_Email,Agency_Website")] Agency agency)
        {
            if (id != agency.Id)
            {
                return NotFound();
